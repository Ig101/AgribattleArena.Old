...
namespace AgribattleArenaBackendServer.Engine
{
    public class SpecEffect : GameObject
    {
        float duration;
        float mod;
        EffectNativeDto native;

        public float Duration { get { return duration; } set { duration = value; } }
        public float Mod { get { return mod; } set { mod = value; } }
        public EffectNativeDto Native { get { return native; } set { native = value; } }

        public SpecEffect(Scene parent, int? ownerId, float x, float y, float? z, EffectNativeDto native, float? duration, float? mod)
